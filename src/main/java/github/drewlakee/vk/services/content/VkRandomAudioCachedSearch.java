...
@Service
@Component
public class VkRandomAudioCachedSearch implements VkContentSearchStrategy {

    private final VkRandomAudioSearch service;
    ...
    @Autowired
    public VkRandomAudioCachedSearch(VkRandomAudioSearch service) {
